...
- [x] Persistent OSC-controlled audio engine
- [x] Continuous musical transport and phrase-aligned changes
- [x] Frontmost macOS application signal
- [x] Local Git workload signal
- [x] Opt-in aggregate Calendar timing
- [x] Manual scenes, intensity, pause, and panic controls
...
- [ ] Linux support
- [ ] Alternative SuperCollider and MIDI backends
- [ ] Community scene and instrument packs
- [ ] Automated musical continuity and loudness tests
